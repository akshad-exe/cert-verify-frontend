...
function AdminLayout({ children }: AdminLayoutProps) {
  ...
  // Optional: Prevent background scroll on mobile when sidebar is open
  useEffect(() => {
    if (sidebarOpen) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col md:flex-row w-full">
      ...
      <div className="md:sticky top-0 z-40">
        <Slide direction="left" triggerOnce>
          <aside
            className={cn(
              "bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 ease-in-out h-screen",
              "md:relative fixed top-0 left-0 z-50", // Mobile = fixed, Desktop = relative
